...
const FAQS = [
  {
    question: '清风明月轩主要提供什么内容？',
    answer:
      '清风明月轩聚合作者的开源项目、技术博客与效率工具，帮助开发者快速了解可直接使用的产品与实践经验。'
  },
  {
    question: '这个站点适合哪些人？',
    answer:
      '适合关注前端工程化、AI 应用实践、自动化工具与独立开发的中文开发者，也适合作为个人作品集参考。'
  },
  {
    question: '站点是否面向全球访问与引用？',
    answer:
      '是。站点内容以中文为主，面向全球开发者开放访问，并提供结构化数据以提升搜索引擎和生成式答案引擎的理解与引用能力。'
  }
]
