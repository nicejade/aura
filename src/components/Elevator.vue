  ...
  <div class="relative">
    <div v-show="isShowButton"
      ...
      <div class="tooltip">
        <div class="pannel desktop:w-[300px]">
          <div class="flex flex-col items-center">
            <img class="block w-[200px] h-[200px]" src="./../assets/images/qrcode.jpeg" alt="微信扫码加好友" />
            <span class="text-blackgrey text-[16px] right-4 pt-[15px]">微信扫码加好友</span>
          </div>
        </div>
        <div class="connect">
          <svg class="eicon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"
      ...
      <button
        ...
        @click="scrollToTop">
        <svg class="!w-5 !h-5 eicon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20"
          style="enable-background: new 0 0 24 24" xml:space="preserve">
          <g />
          <path
    ...
    <div class="desktop:hidden w-full laptop:py-[60px] tablet:py-[40px] tablet:px-[16px]">
      <div class="flex flex-row items-center justify-center space-x-8 tablet:space-x-[16px]">
        <img class="block w-[200px] h-[200px] tablet:w-[140px] tablet:h-[140px]" src="./../assets/images/qrcode.jpeg"
          alt="蓝河操作系统 BlueOS" />
